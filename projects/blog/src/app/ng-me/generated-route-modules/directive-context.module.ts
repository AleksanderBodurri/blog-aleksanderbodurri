...
@Component({
selector: 'ng-me-directive-context',
template: `
  <p>
...
<div class="remark-highlight">
  <pre
    class="language-html"
  ><code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&#x3C;</span>p</span>
  <span class="token attr-name">*appRandomNumber</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>let myRandomNumber = random; let myRandomPercentage = asPercent<span class="token punctuation">"</span></span>
...
export class DirectiveContextPageComponent implements OnInit, OnDestroy {
constructor(
  private meta: Meta
){}
...
ngOnInit(): void {
  ...
  if (true) {
    this.meta.addTag({ property: 'og:url', content: 'https://aleksanderbodurri.com/posts/directive-context' });
  }
  ...
  if (true) {
    this.meta.addTag({ name: 'description', content: 'What is a directive context in Angular?' });
  }

  if (true) {
    this.meta.addTag({ name: 'keywords', content: 'Angular,angular,angular directive,context,directive' });
  }
}
  ...
  RouterModule.forChild([
    {
      path: '',
      pathMatch: 'full',
      component: DirectiveContextPageComponent,
    },
  ]),
