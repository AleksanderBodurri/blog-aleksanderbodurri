...
export class ShieldService {
  ...
  iconRotation = new BehaviorSubject(0);
  ...
  iconNameToVersion: { [name: string]: number } = {
    '360': 14,
    '10k': 10,
    '10mp': 10,
    '11mp': 10,
    ...
    inbox: 17,
    incomplete_circle: 3,
    indeterminate_check_box: 17,
    info: 19,
    input: 13,
    insert_chart: 12,
    insert_chart_outlined: 12,
    insert_comment: 13,
    insert_drive_file: 16,
    insert_emoticon: 15,
    ...
    keyboard_arrow_left: 16,
    keyboard_arrow_right: 16,
    keyboard_arrow_up: 15,
    ...
    local_dining: 20,
    local_drink: 12,
    local_fire_department: 13,
    local_florist: 12,
    local_gas_station: 12,
    ...
    wifi_tethering_error_rounded: 9,
  ...
  materialIconNames = Object.keys(this.iconNameToVersion);
}
